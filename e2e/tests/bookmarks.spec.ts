...
test.describe('Bookmarks App', () => {
  ...
  test.describe('Initial page load', () => {
    test('should load page elements and resources correctly', async ({ page }) => {
      // Check page title
  ...
  test.describe('Add bookmark form', () => {
    test('should toggle form visibility and show form fields', async ({ page }) => {
      const addButton = page.locator('button.toggle-form-btn');
  ...
  test.describe('Adding bookmarks', () => {
    test('should add bookmark and verify display elements', async ({ page }) => {
      // Open the form
      await page.click('button.toggle-form-btn');
  ...
  test.describe('Multiple bookmarks and categories', () => {
    test('should add and organize multiple bookmarks by category', async ({ page }) => {
      const bookmarks = [
      ...
      // Check Dev Tools category has 2 bookmarks
      const devToolsCategory = page.locator('.category').filter({ hasText: 'Dev Tools' });
      await expect(devToolsCategory.locator('.bookmark-item')).toHaveCount(2);

      // Check Productivity category has 1 bookmark
      const productivityCategory = page.locator('.category').filter({ hasText: 'Productivity' });
      await expect(productivityCategory.locator('.bookmark-item')).toHaveCount(1);
    });
